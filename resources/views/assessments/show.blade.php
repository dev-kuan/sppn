    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="px-6 py-4 border-t border-gray-200">
            ...
            <div class="mt-4">
                ...
                <dd class="p-3 mt-1 text-sm text-gray-900 rounded-md bg-yellow-50">{{ $assessment->catatan }}</dd>
            </div>
            @endif
        </div>
    </div>
            ...
            <div x-data="{ open: false }" class="border-b border-gray-100">
                ...
                <div x-show="open" x-collapse class="px-6 py-4">
                    ...
                    <div class="mb-4 last:mb-0">
                        <div class="mb-2 text-sm font-medium text-gray-900">{{ $item->nama_item }}</div>
