                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center space-x-2">
                                <input type="text" name="no_registrasi" id="no_registrasi" value="{{ $noRegistrasi }}"
                                    readonly
                                    class="block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm sm:text-sm cursor-not-allowed font-semibold text-indigo-600">
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                ...
                                Nomor registrasi akan digenerate otomatis saat menyimpan
                            </p>
                            @error('no_registrasi')
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_masuk" id="tanggal_masuk" value="{{ old('tanggal_masuk') }}"
                                x-model="tanggalMasuk" @input="hitung" required
                        ...
                        <div>
                            ...
                            <input type="number" name="lama_pidana_bulan" id="lama_pidana_bulan"
                                value="{{ old('lama_pidana_bulan') }}" x-model="lamaPidana" @input="hitung" min="1" required
                        ...
                        <div>
                            ...
                            <input type="number" name="sisa_pidana_bulan" id="sisa_pidana_bulan"
                                value="{{ old('sisa_pidana_bulan') }}" x-model="sisaPidana" min="0" required
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_bebas" id="tanggal_bebas" value="{{ old('tanggal_bebas') }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="jumlah_residivisme" id="jumlah_residivisme"
                                value="{{ old('jumlah_residivisme', 0) }}" min="0"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div class="pt-6 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="pelatihan" id="pelatihan" value="{{ old('pelatihan') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="program_kerja" id="program_kerja" value="{{ old('program_kerja') }}"
